...
import 'package:fajla/features/admin/cubit/cubit.dart';
import 'package:fajla/features/admin/cubit/states.dart';
import 'package:fajla/features/admin/view/add_ads.dart';
import 'package:fajla/features/admin/view/add_cat.dart';
import 'package:fajla/features/user/model/GetAdsModel.dart';
import 'package:fajla/features/user/view/Section.dart';
import 'package:fajla/features/user/view/ads.dart';
                                                ...
                                                GestureDetector(
                                                  onTap:(){
                                                    cubit.deleteCategories(
                                                        id: cubit.getCatModel[i].id.toString(),
                                                        context: context);
                                                  },
                                                  child: Container(
                                                    width: 35,
