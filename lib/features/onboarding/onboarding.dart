...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingData> onboardingPages = [
    OnboardingData(
      image: 'assets/images/Marketplace-bro.png',
      title: 'مرحبًا بك في فجلة',
      description: 'اكتشف تجربة تسوق فريدة مع فجلة واستكشف مجموعتنا الواسعة من المنتجات الممتازة واحصل على أفضل العروض والجودة العالية',
    ),
    OnboardingData(
      image: 'assets/images/Product hunt-bro.png',
      title: 'ابحث وتسوق',
